@extends('layouts.app')
@section('title') Login to DevStagram @endsection
@section('contents')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            ...
            <div class="mb-5">
                ...
                {{-- Este if viene desde el controlador de logins --}}
                @if (session('message'))
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember"> <label class="text-gray-400">Keep me logged in</label>
                </div>

                <input type="submit" value="Login" class="bg-sky-500 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
